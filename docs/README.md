...
| [`rules.md`](rules.md) | **Game & Fidelity physics rules** (code SSOT; human-readable) |

Behavioral truth (not docs): `./tools/run_truth_suite.sh`.

## Archive

Historical SSOT runbooks, fidelity quest logs, and agent curriculum live under [`archive/`](archive/). Prefer the active docs above for day-to-day work.
